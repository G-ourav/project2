  ...
  return (
    <div className="max-w-[1400px] md:h-[780px] h-[450px] md:w-full m-auto py-16 px-4 relative group">
      ...
      >
        ...
        <div className="flex px-5 overflow-hidden  items-center justify-center gap-4">
          <img className="w-50" src={slides[currentIndex].url2} />

          <img src={slides[currentIndex].url3} />
        </div>

        <img className="overflow-hidden" src={slides[currentIndex].url6} />
